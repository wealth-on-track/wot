...
run('node scripts/autonomous-engine/hourly-guarantee.mjs');
...
run('node scripts/autonomous-engine/sla-guard.mjs');
run('node scripts/autonomous-engine/complete-stalled-job.mjs');
